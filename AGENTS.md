...
├── tests/
│   └── CostSharingApp.Tests/      # 112 xUnit tests (net9.0)
...
|---------|-------------|
| `just validate` | Quick health check: build + 112 tests (self-heals stale builds) |
